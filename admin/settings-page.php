...
<main class="max-w-[1200px] mx-auto w-full px-6 py-10 flex flex-col gap-10">
	...
	<div class="flex flex-col gap-1">
		<h2 class="text-3xl font-bold tracking-tight">
			...
			printf(esc_html__('Welcome back, %s', 'mak8it-smart-image'), esc_html(wp_get_current_user()->display_name));
			?>
		</h2>
		<p class="opacity-60 text-base">
			<?php
			/* translators: %1$d: optimization percentage, %2$s: space saved */
			printf(esc_html__('Your library is %1$d%% optimized. You saved %2$s so far.', 'mak8it-smart-image'), intval($optimization_pct), esc_html($space_saved));
			?>
		</p>
	</div>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
		...
		<div
			...
			<div class="flex items-center gap-1.5">
				...
				<span class="text-success text-sm font-bold"><?php esc_html_e('Media Library', 'mak8it-smart-image'); ?></span>
			</div>
		</div>
		<!-- Stat Card 2 -->
		<div
	...
	<!-- Two Column Layout -->
	<form method="post" action="options.php" id="mak8it-smart-image-main-form">
	<?php settings_fields('Mkit_Si_settings_group'); ?>
	...
	<div class="grid grid-cols-1 lg:grid-cols-3 gap-10 text-[#131118]">
        ...
        <div class="lg:col-span-2 flex flex-col gap-10">
			...
			<div class="glass-card rounded-3xl p-8 shadow-sm">
				<div class="flex justify-between items-start mb-8">
					<div>
						<h4 class="text-xl font-bold"><?php esc_html_e('Optimization Health', 'mak8it-smart-image'); ?></h4>
						<p class="text-sm opacity-80"><?php esc_html_e('Storage usage overview', 'mak8it-smart-image'); ?></p>
					</div>
					<a href="<?php echo esc_url(admin_url('admin.php?page=mak8it-smart-image-bulk')); ?>"
						class="text-primary text-sm font-bold hover:underline"><?php esc_html_e('Run Optimizer', 'mak8it-smart-image'); ?></a>
				</div>
				<div class="flex flex-col md:flex-row items-center gap-12">
					<div class="relative size-48">
						...
						<div class="absolute inset-0 flex flex-col items-center justify-center">
							...
							<span
								class="text-[10px] font-bold opacity-80 uppercase tracking-widest"><?php esc_html_e('Optimized', 'mak8it-smart-image'); ?></span>
						</div>
					</div>
					<div class="flex-1 grid grid-cols-1 gap-4 w-full">
						<div class="flex items-center justify-between p-4 bg-[#f2f0f4]/50 dark:bg-white/5 rounded-2xl">
							<div class="flex items-center gap-3">
								...
								<span
									class="text-sm font-medium"><?php esc_html_e('Optimized Assets', 'mak8it-smart-image'); ?></span>
							</div>
						...
						<div class="flex items-center justify-between p-4 bg-[#f2f0f4]/50 dark:bg-white/5 rounded-2xl">
							<div class="flex items-center gap-3">
								...
								<span
									class="text-sm font-medium"><?php esc_html_e('Original Assets', 'mak8it-smart-image'); ?></span>
							</div>
						...
						<div
							...
							<div class="flex items-center gap-3 text-primary">
								...
								<span class="text-sm font-bold"><?php esc_html_e('Remaining', 'mak8it-smart-image'); ?></span>
							</div>
							<span
			...
			<div class="flex flex-col gap-4">
				<h4 class="text-xl font-bold px-2"><?php esc_html_e('Recent Optimizations', 'mak8it-smart-image'); ?></h4>
						...
						<thead class="bg-[#f2f0f4]/30 dark:bg-white/5">
							<tr>
								<th class="p-4 text-xs font-bold uppercase tracking-widest opacity-40">
									<?php esc_html_e('Thumbnail', 'mak8it-smart-image'); ?>
								</th>
								<th class="p-4 text-xs font-bold uppercase tracking-widest opacity-40">
									<?php esc_html_e('Filename', 'mak8it-smart-image'); ?>
								</th>
								<th class="p-4 text-xs font-bold uppercase tracking-widest opacity-40">
									<?php esc_html_e('Savings', 'mak8it-smart-image'); ?>
								</th>
								<th class="p-4 text-xs font-bold uppercase tracking-widest opacity-40">
									<?php esc_html_e('Status', 'mak8it-smart-image'); ?>
								</th>
								<th class="p-4 text-xs font-bold uppercase tracking-widest opacity-40 text-right">
									<?php esc_html_e('Action', 'mak8it-smart-image'); ?>
								</th>
							</tr>
						</thead>
						<tbody class="divide-y divide-[#f2f0f4] dark:divide-white/5">
							<?php
							$recent_conversions = Mkit_Si_Stats::get_recent_conversions(5);
							if (!empty($recent_conversions)):
									...
									<tr class="hover:bg-primary/[0.02] transition-colors">
										...
										<td class="p-4">
											<div class="flex items-center gap-1.5 text-success">
												...
												<span
													class="text-xs font-bold"><?php esc_html_e('Optimized', 'mak8it-smart-image'); ?></span>
											</div>
										</td>
								...
								<tr>
									<td colspan="5" class="p-10 text-center opacity-40 font-medium">
										<?php esc_html_e('No optimizations yet.', 'mak8it-smart-image'); ?>
									</td>
								</tr>
							<?php endif; ?>
						</tbody>
		...
		<div class="rounded-3xl p-8 mb-6" style="background:#fff;border:1px solid #f2f0f4;">
			...
			<div class="flex items-center justify-between mb-8">
				<div class="flex items-center gap-3">
					<h4 class="text-xl font-bold" style="margin:0;color:#131118;"><?php esc_html_e('AI Vision Engine', 'mak8it-smart-image'); ?></h4>
				</div>
				<!-- Badge -->
				<span style="background:#faf8fc;border:1px solid #f2f0f4;border-radius:6px;padding:4px 10px;font-size:9px;font-weight:800;letter-spacing:0.05em;text-transform:uppercase;color:#7c3bed;">
					<?php esc_html_e('Included Free', 'mak8it-smart-image'); ?>
				</span>
			</div>

			<!-- Card Body (No nested form tag) -->
			<div id="mak8it-smart-image-ai-container" style="display:flex;flex-direction:column;gap:20px;">
				...
				<div class="flex items-center justify-between" style="background:#faf8fc;border:1px solid #f2f0f4;border-radius:14px;padding:14px 18px;">
					<div>
						<p style="font-size:14px;font-weight:700;color:#131118;margin:0 0 3px;"><?php esc_html_e('Generate Alt Text', 'mak8it-smart-image'); ?></p>
						<p style="font-size:11px;color:#64748b;margin:0;font-weight:500;"><?php esc_html_e('Auto-writes SEO alt tags using Vision AI', 'mak8it-smart-image'); ?></p>
					</div>
					<label class="relative inline-flex items-center cursor-pointer">
						<input type="hidden" name="Mkit_Si_settings[auto_alt]" value="0">
						<input type="checkbox" name="Mkit_Si_settings[auto_alt]" value="1" <?php checked(isset($settings['auto_alt']) ? $settings['auto_alt'] : '0', '1'); ?> class="sr-only peer">
				...
				<div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
					<div>
						<p style="font-size:10px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:#64748b;margin:0 0 8px 2px;"><?php esc_html_e('AI Provider', 'mak8it-smart-image'); ?></p>
						<div style="position:relative;">
							<select name="Mkit_Si_settings[ai_provider]" id="ai-provider-select" style="width:100% !important; height:46px !important; background:#fff !important; border:1.5px solid #f2f0f4 !important; color:#131118 !important; padding:0 36px 0 14px !important; border-radius:12px !important; font-size:13px !important; font-weight:600 !important; appearance:none !important; -webkit-appearance:none !important; -moz-appearance:none !important; outline:none !important; cursor:pointer !important; transition:border-color 0.2s !important; box-sizing:border-box !important; line-height:46px !important;">
								...
								<option value="other" <?php selected(isset($settings['ai_provider']) ? $settings['ai_provider'] : 'gemini', 'other'); ?>><?php esc_html_e('Custom (OpenAI Compatible)', 'mak8it-smart-image'); ?></option>
							</select>
							<span class="material-symbols-outlined" style="position:absolute;right:12px;top:50%;transform:translateY(-50%);font-size:18px;color:#94a3b8;pointer-events:none;">expand_more</span>
						</div>
					</div>
					<div>
						<p style="font-size:10px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:#64748b;margin:0 0 8px 2px;"><?php esc_html_e('Neural Model', 'mak8it-smart-image'); ?></p>
						<div style="position:relative;">
							<input type="text" name="Mkit_Si_settings[ai_model]" id="ai-model-input" list="ai-model-suggestions" value="<?php echo esc_attr(isset($settings['ai_model']) ? $settings['ai_model'] : 'gemini-1.5-flash'); ?>" style="width:100% !important; height:46px !important; background:#fff !important; border:1.5px solid #f2f0f4 !important; color:#131118 !important; padding:0 14px !important; border-radius:12px !important; font-size:13px !important; font-weight:600 !important; outline:none !important; box-sizing:border-box !important; transition:border-color 0.2s !important;" placeholder="<?php esc_attr_e('Enter model name...', 'mak8it-smart-image'); ?>">
				...
				<div>
					<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;padding:0 2px;">
						<p style="font-size:10px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:#64748b;margin:0;"><?php esc_html_e('Secret API Key', 'mak8it-smart-image'); ?></p>
						<a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" style="font-size:10px;font-weight:700;color:#7c3bed;text-decoration:none;letter-spacing:0.05em;"><?php esc_html_e('Get Free Key ↗', 'mak8it-smart-image'); ?></a>
					</div>
					<input type="password" name="Mkit_Si_settings[ai_api_key]" value="<?php echo esc_attr(isset($settings['ai_api_key']) ? $settings['ai_api_key'] : ''); ?>" style="width:100% !important; height:46px !important; background:#fff !important; border:1.5px solid #f2f0f4 !important; color:#131118 !important; padding:0 14px !important; border-radius:12px !important; font-size:13px !important; font-weight:600 !important; outline:none !important; box-sizing:border-box !important; transition:border-color 0.2s !important;" placeholder="<?php esc_attr_e('Paste your API key here...', 'mak8it-smart-image'); ?>">
				</div>

				<!-- API Endpoint URL Field -->
				<div>
					<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;padding:0 2px;">
						<p style="font-size:10px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:#64748b;margin:0;"><?php esc_html_e('Custom API URL (Optional)', 'mak8it-smart-image'); ?></p>
					</div>
					<input type="text" name="Mkit_Si_settings[ai_api_url]" value="<?php echo esc_attr(isset($settings['ai_api_url']) ? $settings['ai_api_url'] : ''); ?>" style="width:100% !important; height:46px !important; background:#fff !important; border:1.5px solid #f2f0f4 !important; color:#131118 !important; padding:0 14px !important; border-radius:12px !important; font-size:13px !important; font-weight:600 !important; outline:none !important; box-sizing:border-box !important; transition:border-color 0.2s !important;" placeholder="<?php esc_attr_e('Leave empty for default API URL...', 'mak8it-smart-image'); ?>">
				</div>
				...
				<div class="grid grid-cols-2 gap-4 mt-2">
					<button type="button" id="btn-test-ai" class="w-full bg-[#f2f0f4] dark:bg-white/5 hover:bg-primary hover:text-white py-3 rounded-xl text-sm font-bold transition-all border border-transparent hover:border-primary/20 flex items-center justify-center gap-2">
						...
						<?php esc_html_e('Test API', 'mak8it-smart-image'); ?>
					</button>
					<button type="submit" class="w-full bg-primary text-white hover:bg-[#f2f0f4] hover:text-[#131118] py-3 rounded-xl text-sm font-bold transition-all border border-transparent">
						<?php esc_html_e('Save AI Engine', 'mak8it-smart-image'); ?>
					</button>
				</div>
			...
			<div class="glass-card rounded-3xl p-6 shadow-sm">
				<div class="flex items-center gap-3 mb-4">
					...
					<h4 class="text-xl font-bold"><?php esc_html_e('Compression Settings', 'mak8it-smart-image'); ?></h4>
				</div>
				...
				<div class="flex flex-col gap-4">
						...
						<div class="flex items-center justify-between">
							<div>
								<p class="text-sm font-bold"><?php esc_html_e('Auto Convert', 'mak8it-smart-image'); ?></p>
								<p class="text-xs opacity-70"><?php esc_html_e('Recommended for speed', 'mak8it-smart-image'); ?>
								</p>
							</div>
							<label class="relative inline-flex items-center cursor-pointer">
								<input type="hidden" name="Mkit_Si_settings[auto_convert]" value="0">
								<input type="checkbox" name="Mkit_Si_settings[auto_convert]" value="1" <?php checked($auto_convert, '1'); ?> class="sr-only peer">
								<div
						...
						<div class="flex flex-col gap-4">
							<div class="flex justify-between items-center">
								<p class="text-sm font-bold"><?php esc_html_e('Compression Level', 'mak8it-smart-image'); ?></p>
								<span class="text-sm font-bold text-primary"
									id="quality-val-display"><?php echo esc_html($quality); ?>%</span>
							</div>
							<input type="range" name="Mkit_Si_settings[quality]" min="10" max="100"
							...
							<div class="flex justify-between text-[10px] opacity-75 font-bold uppercase tracking-wider">
								<span><?php esc_html_e('Max Savings', 'mak8it-smart-image'); ?></span>
								<span><?php esc_html_e('Recommended (80%)', 'mak8it-smart-image'); ?></span>
								<span><?php esc_html_e('Best Quality', 'mak8it-smart-image'); ?></span>
							</div>
						</div>
						...
						<!-- Radio Buttons -->
						<div class="flex flex-col gap-4">
							<p class="text-sm font-bold"><?php esc_html_e('Replacement Strategy', 'mak8it-smart-image'); ?></p>
							<div class="space-y-3">
								<label class="flex items-center gap-3 cursor-pointer group">
									<input type="radio" name="Mkit_Si_settings[replace_original]" value="replace"
										<?php checked($replace_mode, 'replace'); ?>
										class="w-4 h-4 text-primary bg-gray-100 border-gray-300 focus:ring-primary focus:ring-2">
									<span
										class="text-sm font-medium opacity-80 group-hover:opacity-100 transition-opacity"><?php esc_html_e('Overwrite original files', 'mak8it-smart-image'); ?></span>
								</label>
								<label class="flex items-center gap-3 cursor-pointer group">
									<input type="radio" name="Mkit_Si_settings[replace_original]"
										value="keep_both" <?php checked($replace_mode, 'keep_both'); ?>
										class="w-4 h-4 text-primary bg-gray-100 border-gray-300 focus:ring-primary focus:ring-2">
									<span
										class="text-sm font-medium opacity-80 group-hover:opacity-100 transition-opacity"><?php esc_html_e('Keep backup of originals', 'mak8it-smart-image'); ?></span>
								</label>
							</div>
						</div>
						...
						<div class="pt-2">
							<button type="button" 
								...
								<div class="flex items-center gap-2">
									...
									<?php esc_html_e('Advanced Configuration', 'mak8it-smart-image'); ?>
								</div>
							...
							<div id="advanced-settings-area" class="hidden pt-4">
								<div class="grid grid-cols-2 gap-4">
									<div>
										<label class="text-[10px] font-extrabold uppercase tracking-tight opacity-40 mb-2 block"><?php esc_html_e('Min Size (KB)', 'mak8it-smart-image'); ?></label>
										<input type="number" name="Mkit_Si_settings[min_size]" value="<?php echo esc_attr(isset($settings['min_size']) ? $settings['min_size'] : '0'); ?>" min="0" class="w-full bg-[#f2f0f4]/50 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-bold focus:ring-1 focus:ring-primary">
									</div>
									<div>
										<label class="text-[10px] font-extrabold uppercase tracking-tight opacity-40 mb-2 block"><?php esc_html_e('Max Size (MB)', 'mak8it-smart-image'); ?></label>
										<input type="number" name="Mkit_Si_settings[max_size]" value="<?php echo esc_attr(isset($settings['max_size']) ? $settings['max_size'] : '10'); ?>" min="0" class="w-full bg-[#f2f0f4]/50 dark:bg-white/5 border-none rounded-xl p-3 text-sm font-bold focus:ring-1 focus:ring-primary">
									</div>
								</div>
								<p class="text-[10px] opacity-40 mt-3 font-medium italic">
									<?php esc_html_e('* Use 0 to disable minimum or maximum file size checks.', 'mak8it-smart-image'); ?>
								</p>
							</div>
						</div>
						...
						<button type="submit"
							...
							<?php esc_html_e('Save Configuration', 'mak8it-smart-image'); ?>
						</button>
					</div>
				</div>
