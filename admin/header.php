		...
		<div class="max-w-[1200px] mx-auto flex items-center justify-between px-6">
			<div class="flex items-center gap-3">
				<div class="bg-primary p-1.5 rounded-lg text-white">
					<span class="material-symbols-outlined text-[20px] block">filter_center_focus</span>
				</div>
				<div>
					<h1 class="text-lg font-bold tracking-tight"><?php esc_html_e('Img Panda', 'img-panda'); ?></h1>
					<p class="text-[10px] font-medium opacity-50 uppercase tracking-widest">
						v<?php echo esc_html(IMG_PANDA_VERSION); ?> Premium</p>
				</div>
			</div>
